...
import src.Tp5_p7cCorales  # noqa


class TestTp5_p7cCorales(unittest.TestCase):
    def test_si_o_no_editar_telefono(self):
        """Testea si segun ingresa 'si' o 'no' si decide o no editar
        teléfono"""
        self.assertEqual(src.Tp5_p7cCorales.si_o_no_editar_telefono("Si"),
                         ("Editar teléfono"))
        self.assertEqual(src.Tp5_p7cCorales.si_o_no_editar_telefono("si"),
                         ("Editar teléfono"))
        self.assertEqual(src.Tp5_p7cCorales.si_o_no_editar_telefono("No"),
    ...
    def test_crear_o_no_telefono(self):
        ...
        teléfono"""
        self.assertEqual(src.Tp5_p7cCorales.crear_o_no_telefono("Si"),
                         ("Crear teléfono"))
        self.assertEqual(src.Tp5_p7cCorales.crear_o_no_telefono("si"),
                         ("Crear teléfono"))
        self.assertEqual(src.Tp5_p7cCorales.crear_o_no_telefono("No"),
                         ("No crear"))
        self.assertEqual(src.Tp5_p7cCorales.crear_o_no_telefono("no"),
                         ("No crear"))
    ...
    def test_editar_telefono(self):
        ...
        self.assertEqual(src.Tp5_p7cCorales.editar_telefono
                         ("Carlos", "1156982059"),
                         ("1156982059"))
        self.assertEqual(src.Tp5_p7cCorales.editar_telefono
                         ("Carlos", "asdasd"),
    ...
    def test_crear_telefono(self):
        """Testea en qué casos devuelve error si se mete cualquier
        otra cosa que no sea un número y tenga 10 cifras"""
        self.assertEqual(src.Tp5_p7cCorales.crear_telefono
    ...
    def test_proceso_nombre(self):
        ...
        self.assertEqual(src.Tp5_p7cCorales.proceso_nombre
    ...
    def test_preguntar_nombre(self):
        ...
        self.assertEqual(src.Tp5_p7cCorales.preguntar_nombre("Carlos"),
                         ("carlos"))
        self.assertEqual(src.Tp5_p7cCorales.preguntar_nombre("Elba Nana"),
                         ("elba nana"))
        self.assertEqual(src.Tp5_p7cCorales.preguntar_nombre("RUBEN "),
                         ("ruben"))
        self.assertEqual(src.Tp5_p7cCorales.preguntar_nombre
                         ("Aaa 123"), ("Error"))
        self.assertEqual(src.Tp5_p7cCorales.preguntar_nombre("   "),
                         ("Error"))
        self.assertEqual(src.Tp5_p7cCorales.preguntar_nombre
